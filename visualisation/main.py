...
def osu(basepath_data: pathlib.Path,
         basepath_figures: pathlib.Path,
          save: bool):

    #
    container_lat_vni = visualisation.loader.load_osu(folder="measurements_lm-mpi-job-mpilauncher-0_osu_latency_25-04-25T1031",
                                                  basepath_data=basepath_data / "osu" / "container", tag="vni:true")
    container_bw_vni = visualisation.loader.load_osu(folder="measurements_lm-mpi-job-mpilauncher-0_osu_bw_25-04-25T1033",
                                                 basepath_data=basepath_data / "osu" / "container", tag="vni:true")

    container_lat = visualisation.loader.load_osu(folder="measurements_lm-mpi-job-mpilauncher-0_osu_latency_25-04-25T1015",
                                                  basepath_data=basepath_data / "osu" / "container", tag="vni:false")
    container_bw = visualisation.loader.load_osu(folder="measurements_lm-mpi-job-mpilauncher-0_osu_bw_25-04-25T1017",
                                                 basepath_data=basepath_data / "osu" / "container", tag="vni:false")

    host_lat = visualisation.loader.load_osu(folder="measurements_cn03_osu_latency_25-04-25T1211",
                                             basepath_data=basepath_data / "osu" / "host", tag="host")
    host_bw = visualisation.loader.load_osu(folder="measurements_cn03_osu_bw_25-04-25T1201",
                                            basepath_data=basepath_data / "osu" / "host", tag="host")
    ...
    visualisation.visualise.lineplot_osu(
        ...
        y_minor_locator=matplotlib.ticker.MultipleLocator(0.0025),
    ...
    visualisation.visualise.lineplot_osu(
            ...
            y_decimals=0,
            y_major_locator=matplotlib.ticker.MultipleLocator(0.02),
